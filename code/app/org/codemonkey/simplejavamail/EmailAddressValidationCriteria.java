...
/**
 * Defines a set of restriction flags for simpleMail address validation. To remain completely true to RFC 2822, all flags should be set to
 * <code>true</code>.
 * 
...
public class EmailAddressValidationCriteria {
	 ...
	 *            <li>This flag states whether domain literals are allowed in the simpleMail address, e.g.:
	 *            <p>
	 ...
	 *            </p>
	 *            <p>
	 *            The RFC says these are valid simpleMail addresses, but most people don't like allowing them. If you don't want to allow them,
